...
class TabIndividualProfile extends StatefulWidget {
  @override
  _TabIndividualProfileState createState() => _TabIndividualProfileState();
}

class _TabIndividualProfileState extends State<TabIndividualProfile> {
    ...
    return SafeArea(
          child: SingleChildScrollView(
            child: Stack(fit: StackFit.loose, children: <Widget>[
              ...
              Positioned(                
                child: InkWell(
                  onTap: ()=> fetchImage(ImageSource.gallery, 0),
                  child: _coverPage()
                )
              ),
              Positioned(
                ...
                left: 30.0,
                child: InkWell(
                  onTap: ()=>fetchImage(ImageSource.gallery,1),
